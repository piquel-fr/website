...
func main() {
	...
	// Auth
	router.HandleFunc("/authentication/login", handler.HandleLogin).Methods("GET")
	router.HandleFunc("/authentication/logout", handler.HandleLogout).Methods("GET")
	router.HandleFunc("/authentication/{provider}", handler.HandleProviderLogin).Methods("GET")
	router.HandleFunc("/authentication/{provider}/callback", handler.HandleAuthCallback).Methods("GET")
